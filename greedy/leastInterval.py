...
def leastInterval(tasks: List[str], n: int) -> int:  
    ...
    length_of_all_chunks = (num_of_chunks_with_idles*length_of_a_chunk_with_idles) + length_of_the_final_chunk # 2*3 + 2 = 8 
    # -> A B _ A B _ A B 
...
assert leastInterval(["A","A","A","A","A","A","B","C","D","E","F","G"], n = 2) == 16 
